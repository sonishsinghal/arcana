...
def plot_generator(start, end, asset):
    ...
    ax2.set_title(' RELATIVESTRENGTH INDEX')
    plt.savefig(f"./images/Relative_Strength_Index.jpg")

    plt.figure(figsize=(10, 8))
    plt.plot(data['Close'], linewidth=2.5)
    plt.title("Close_Price")
    plt.savefig(f"./images/Close_Price.jpg")

    plt.figure(figsize=(10, 8))
    plt.plot(data['Open'], linewidth=2.5)
    plt.title("Open_Price")
    plt.savefig(f"./images/Open_Price.jpg")

    plt.figure(figsize=(10, 8))

    plt.plot(data['High'], linewidth=2.5)
    plt.title("High_Price")
    plt.savefig(f"./images/High_Price.jpg")

    plt.figure(figsize=(10, 8))
    plt.plot(data['Low'], linewidth=2.5)
    plt.title("Low_Price")
    plt.savefig(f"./images/Low_Price.jpg")
...
# plot close price, short-term and long-term moving averages
    ...
    plt.legend()
    plt.grid()
    plt.savefig(f"./images/Moving_avg.jpg")
    ...
    plt.legend()
    plt.savefig(f"./images/Bollinger_Bands.jpg")
